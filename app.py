...
def app():
    ...
    st.title("Who Tweets What 🔥")


    activities=["Tweet Analyzer","Generate Twitter Data","About"]
    ...
    if choice=="Tweet Analyzer":
        ...
        if st.button("Analyze"):
            ...
            if Analyzer_choice == "Show Recent Tweets":
                ...
                def gen_wordcloud():
                    ...
                    posts = api.user_timeline(screen_name=raw_text, count = tcount, lang ="en", tweet_mode="extended")
        ...
        st.markdown ("This app was designed to see who you follow and whether they demonstrate any hard bias.")
        st.header("Built with Streamlit by [Yash Pathania](https://www.linkedin.com/in/yash-pathania-03a0301b4/)")
        st.text("Yash Pathania (Yash)")		
